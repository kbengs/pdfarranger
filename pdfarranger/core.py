...
class PDFRenderer(threading.Thread, GObject.GObject):
    ...
    def run(self):
        ...
        Thumbnails are rendered for the visible range and its near area. Previews are
    ...
    def finish(self):
        """Signal rendering ended (for statusbar and mem_trim)."""
        GObject.idle_add(
            self.emit,
            "update_thumbnail",
            None,
